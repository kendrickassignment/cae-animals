...
export const seedAnalyses: SeedAnalysis[] = [
  {
    ...
    findings: [
      ...
      { id: "f11", finding_type: "commitment_downgrade", severity: "high", title: "Weakened From '100% by 2025' to 'Aim by 2030'", description: "The company's original public commitment was '100% cage-free by 2025 globally.' This report now uses 'aim to achieve similar standards by 2030' — a downgrade from an absolute deadline to aspirational language with a 5-year extension.", exact_quote: "Elsewhere globally, we aim to achieve similar standards by 2030.", page_number: 0, section: "ESG Report — Animal Welfare Section", paragraph: "Global Commitment", country_affected: "Indonesia" },
      { id: "f12", finding_type: "silent_delisting", severity: "critical", title: "Indonesia Removed from 'Priority Markets' List", description: "Yum! Brands' 2022 report listed Indonesia as a 'Priority Market' for cage-free transition. The 2024 report no longer includes Indonesia in its 'participating markets' list — the country has been quietly delisted without any public announcement or explanation.", exact_quote: "Our participating markets include the United States, Canada, United Kingdom, France, Germany, Australia, Thailand, and Malaysia.", page_number: 0, section: "ESG Report — Regional Progress", paragraph: "Participating Markets", country_affected: "Indonesia" },
    ],
  },
  {
    ...
    findings: [
      ...
      { id: "f13", finding_type: "corporate_ghosting", severity: "high", title: "No Stakeholder Engagement on Animal Welfare", description: "The report contains no stakeholder engagement section related to animal welfare, no mention of NGO partnerships, and no contact information for sustainability inquiries. Despite receiving public letters from advocacy groups, the report provides no response or acknowledgment.", exact_quote: "", page_number: 0, section: "Stakeholder Engagement", paragraph: null, country_affected: null },
    ],
  },
  {
  ...
  },
  {
    ...
    findings: [
      ...
      { id: "f14", finding_type: "silent_delisting", severity: "critical", title: "Southeast Asian Markets Removed from Scope", description: "IKEA's 2022 sustainability report listed 'Southeast Asia' as a target region for cage-free transition. The 2024 report's country list conspicuously omits all Southeast Asian nations, reducing the geographic scope without any announcement. (Hypothetical demo.)", exact_quote: "Our cage-free sourcing program currently covers markets in Europe, North America, and Oceania.", page_number: 28, section: "Regional Progress", paragraph: null, country_affected: "Indonesia" },
      { id: "f15", finding_type: "commitment_downgrade", severity: "high", title: "Scope Narrowed from 'All Products' to 'Select Categories'", description: "IKEA's original 2020 commitment applied to 'all food products containing eggs.' The 2024 report now references 'select product categories,' quietly reducing the scope. (Hypothetical demo.)", exact_quote: "We continue to increase cage-free sourcing across select product categories in our food operations.", page_number: 53, section: "Animal Welfare", paragraph: "Product Scope", country_affected: null },
    ],
  },
];
...
export function getFindingTypeLabel(type: string): string {
  switch (type) {
    ...
    case "silent_delisting": return "Silent Delisting";
    case "corporate_ghosting": return "Corporate Ghosting";
    case "commitment_downgrade": return "Commitment Downgrade";
