...
export const seedAnalyses: SeedAnalysis[] = [
  {
    ...
    findings: [
      { id: "f1", finding_type: "geographic_exclusion", severity: "critical", title: "Geographic Tiering — Indonesia Classified as 'Elsewhere'", description: "The company's 94% figure only counts operations in leading markets. Indonesia is grouped under 'Elsewhere globally' with a distant 2030 target, effectively excluding it from current commitments.", exact_quote: "Our 94% cage-free figure reflects operations in the U.S., Western Europe and other leading markets. Elsewhere globally, we aim to achieve similar standards by 2030.", page_number: 87, section: "ESG Report 2024", paragraph: "Regional Progress", country_affected: "Indonesia" },
      { id: "f2", finding_type: "hedging_language", severity: "high", title: "Non-Binding 'Aim To' Language", description: "The word 'aim' is legally non-binding and creates no enforceable commitment for Southeast Asian markets.", exact_quote: "we aim to achieve similar standards by 2030", page_number: 87, section: "ESG Report 2024", paragraph: null, country_affected: null },
      { id: "f3", finding_type: "timeline_deferral", severity: "high", title: "2030 Deadline for Non-Leading Markets", description: "A 2030 deadline for 'elsewhere' markets represents a 5+ year deferral with no interim milestones or accountability mechanisms.", exact_quote: "Elsewhere globally, we aim to achieve similar standards by 2030.", page_number: 87, section: null, paragraph: null, country_affected: "Indonesia" },
    ],
  },
  {
  ...
  },
  {
    ...
    findings: [
      { id: "f6", finding_type: "franchise_firewall", severity: "critical", title: "Franchise Firewall — Licensee Exclusion", description: "The commitment only covers 'company-operated stores.' Indonesia is run by licensee PT Sari Coffee Indonesia, creating a structural exclusion from the commitment.", exact_quote: "This commitment applies to company-operated stores globally.", page_number: 56, section: "Animal Welfare Policy", paragraph: null, country_affected: "Indonesia" },
      { id: "f7", finding_type: "strategic_silence", severity: "high", title: "Indonesia Absent from Animal Welfare Section", description: "Despite operating in Indonesia through a licensee, the country is not mentioned in the animal welfare or cage-free progress sections of the report.", exact_quote: "", page_number: 0, section: "Animal Welfare Section (Pages 50-65)", paragraph: null, country_affected: "Indonesia" },
    ],
  },
  {
  ...
  },
  {
    ...
    summary: "IKEA's 200-page sustainability report contains zero mentions of Indonesia in its Regional Progress section, which covers 28 countries. This 'strategic silence' is itself a red flag — the company makes a 'Global' commitment but simply does not report on one of Southeast Asia's largest markets.",
    status: "completed", created_at: "2026-02-05T12:00:00Z",
    findings: [
      { id: "f9", finding_type: "strategic_silence", severity: "critical", title: "Complete Strategic Silence on Indonesia", description: "Indonesia does not appear anywhere in the 200-page report despite IKEA's 'Global' cage-free commitment. The Regional Progress section covers 28 countries but excludes Indonesia entirely.", exact_quote: "", page_number: 0, section: "Regional Progress (Pages 45-78)", paragraph: null, country_affected: "Indonesia" },
